...
type Point struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Lat           float64                `protobuf:"fixed64,1,opt,name=lat,proto3" json:"lat,omitempty"` // y
	Lng           float64                `protobuf:"fixed64,2,opt,name=lng,proto3" json:"lng,omitempty"` // x
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Store struct {
	...
	DateJoined    *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=date_joined,json=dateJoined,proto3" json:"date_joined,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Store) GetDateJoined() *timestamppb.Timestamp {
	if x != nil {
		return x.DateJoined
	}
	return nil
...
const file_domain_proto_rawDesc = "" +
	"\n" +
	"\fdomain.proto\x12\vmuydelcampo\x1a\x16google/type/date.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa1\x02\n" +
	"\x04User\x12\x10\n" +
	...
	"\x03lng\x18\x02 \x01(\x01R\x03lng\"\xcc\x01\n" +
	"\x05Store\x12\x10\n" +
	"\x03ref\x18\x01 \x01(\tR\x03ref\x12\x12\n" +
	"\x04code\x18\x02 \x01(\tR\x04code\x12&\n" +
	"\x04geom\x18\x03 \x01(\v2\x12.muydelcampo.PointR\x04geom\x12\x1b\n" +
	...
	"\n" +
	"until_unix\x18\b \x01(\x03R\tuntilUnix\"\xfd\x01\n" +
	"\x05Place\x12\x10\n" +
	"\x03ref\x18\x01 \x01(\tR\x03ref\x12\x10\n" +
	...
	"\bsubtitle\x18\x04 \x01(\tR\bsubtitleB\x18Z\x16apigo/protobuf/gen/v1;b\x06proto3"
...
var file_domain_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_domain_proto_goTypes = []any{
	(*User)(nil),                  // 0: muydelcampo.User
	(*UserAddr)(nil),              // 1: muydelcampo.UserAddr
	(*Genre)(nil),                 // 2: muydelcampo.Genre
	(*Product)(nil),               // 3: muydelcampo.Product
	(*Point)(nil),                 // 4: muydelcampo.Point
	(*Store)(nil),                 // 5: muydelcampo.Store
	(*Order)(nil),                 // 6: muydelcampo.Order
	(*OrderNote)(nil),             // 7: muydelcampo.OrderNote
	(*OrderLine)(nil),             // 8: muydelcampo.OrderLine
	(*DeliverySlot)(nil),          // 9: muydelcampo.DeliverySlot
	(*Place)(nil),                 // 10: muydelcampo.Place
	(*Prediction)(nil),            // 11: muydelcampo.Prediction
	(*timestamppb.Timestamp)(nil), // 12: google.protobuf.Timestamp
	(*date.Date)(nil),             // 13: google.type.Date
}
var file_domain_proto_depIdxs = []int32{
	12, // 0: muydelcampo.User.last_login:type_name -> google.protobuf.Timestamp
	12, // 1: muydelcampo.User.date_joined:type_name -> google.protobuf.Timestamp
	12, // 2: muydelcampo.UserAddr.date_created:type_name -> google.protobuf.Timestamp
	12, // 3: muydelcampo.UserAddr.date_updated:type_name -> google.protobuf.Timestamp
	12, // 4: muydelcampo.Genre.date_created:type_name -> google.protobuf.Timestamp
	2,  // 5: muydelcampo.Product.genre:type_name -> muydelcampo.Genre
	12, // 6: muydelcampo.Product.date_created:type_name -> google.protobuf.Timestamp
	12, // 7: muydelcampo.Product.date_updated:type_name -> google.protobuf.Timestamp
	4,  // 8: muydelcampo.Store.geom:type_name -> muydelcampo.Point
	12, // 9: muydelcampo.Store.date_joined:type_name -> google.protobuf.Timestamp
	0,  // 10: muydelcampo.Order.user:type_name -> muydelcampo.User
	1,  // 11: muydelcampo.Order.addr:type_name -> muydelcampo.UserAddr
	9,  // 12: muydelcampo.Order.slot:type_name -> muydelcampo.DeliverySlot
	12, // 13: muydelcampo.Order.date_created:type_name -> google.protobuf.Timestamp
	12, // 14: muydelcampo.Order.date_updated:type_name -> google.protobuf.Timestamp
	12, // 15: muydelcampo.OrderNote.date_created:type_name -> google.protobuf.Timestamp
	3,  // 16: muydelcampo.OrderLine.item:type_name -> muydelcampo.Product
	13, // 17: muydelcampo.DeliverySlot.work_date:type_name -> google.type.Date
