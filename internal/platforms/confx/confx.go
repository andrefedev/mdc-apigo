...
func Load() (Config, error) {
	...
	if cfg.WhatsAppToken == "" {
		return Config{}, errors.New("confx load(): you must set your 'WHATSAPP_TOKEN' env var")
	}

	if cfg.WhatsAppPhone == "" {
		return Config{}, errors.New("confx load(): you must set your 'WHATSAPP_PHONE' env var")
	}
